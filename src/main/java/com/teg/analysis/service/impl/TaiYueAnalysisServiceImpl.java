...
public class TaiYueAnalysisServiceImpl implements AnalysisService {
    private final static Logger LOGGER = LoggerFactory.getLogger(TaiYueAnalysisServiceImpl.class);
    ...
    public List<AnalysisResultDTO> analysis(String filePath) {
        ...
        LOGGER.info("开始处理文件" + excelData.size() + "个");
        ...
        list.forEach(integerObjectMap -> executorService.execute(() -> {
            ...
            try {
                analysisResultDTO = fillDetail(integerObjectMap);
    ...
    private AnalysisResultDTO fillDetail(Map<Integer, Object> data) throws URISyntaxException {

        Map<String, String> taiYueMap = taiYueService.post2TYInfo(String.valueOf(data.get(1)));
